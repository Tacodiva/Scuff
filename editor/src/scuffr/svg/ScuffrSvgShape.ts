...
export abstract class ScuffrSvgShape<TContent extends ScuffrSvgShapeContent = ScuffrSvgShapeContent> extends ScuffrSvgElementParent implements ScuffrSvgBlockPart {
    ...
    public get content(): TContent { return this.children[0]; }
