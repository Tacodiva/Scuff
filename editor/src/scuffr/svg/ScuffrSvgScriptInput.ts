...
import { BlockScriptInput, Vec2 } from "@scuff/core";
import type { ScuffrSvgBlockPart } from "..";

export class ScuffrSvgScriptInput extends ScuffrSvgScript<BlockScriptInput> implements ScuffrSvgBlockPart, ScuffrShapeModifier {
