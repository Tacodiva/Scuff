...
export abstract class ScuffrSvgElement extends ScuffrElement<SVGGraphicsElement> {
    ...
    public dimensions: MutVec2;
    public topLeftOffset: MutVec2;

    public translationSelf: MutVec2;
    public translationParent: MutVec2;
    ...
    private _lastTranslationUpdate: MutVec2;
    private _absoluteTranslation: MutVec2 | null;
