...
import { Bounds, type BlockInstance, type MutVec2, type Vec2 } from "@scuff/core";
...
export abstract class ScuffrElementScriptContainer extends ScuffrElement<SVGElement> implements ScuffrElementParent {
    ...
    public contentTranslation: MutVec2;
    ...
    public toWorkspaceCoords(pos: Vec2): MutVec2 {
        return {
    ...
    public toViewportCoords(pos: Vec2): MutVec2 {
        return {
