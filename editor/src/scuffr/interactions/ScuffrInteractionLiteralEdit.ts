...
export class ScuffrInteractionLiteralEdit extends ScuffEditorInteraction {
    ...
    public constructor(input: ScuffrSvgInputLiteral) {
        ...
        this.initalValue = input.getText();
        ...
        this.htmlInput.value = this.scuffrInput.getText();
    ...
    private _updateDOM() {
        ...
        let isValueValid = this.scuffrInput.isTextValid();
    ...
    private _onInputChange = () => {
        this.scuffrInput.setText(this.htmlInput.value);
        this._updateDOM();
    };

    public override onEnd(): void {
        if (!this.inputValid) {
            this.scuffrInput.setText(this.initalValue);
        } else if (this.scuffrInput.getText() !== this.initalValue) {
            this.scuffrInput.workspace.submitCommand(
                new ScuffrCmdSetInputLiteral(this.scuffrInput, this.scuffrInput.getText(), this.initalValue),
                false
            );
        }
